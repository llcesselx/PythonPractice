...
def help_menu():
    ...
    print("-H  --horizontal  -----------  Set top and bottom character")
    print('                               i.e. -H "-" will set top')
    print("                               and bottom borders to -\n")
    print("-V  --vertical  -------------  Set side border character")
    print('                               i.e. -V "|" will set sides')
    print("                               to | character\n")
    print("-C  --corner  ---------------  Set the corner characters")
    print('                               i.e. -C "+" will set corners')
    print("                               to + character")
    print("               Directions:\n")
...
if "-H" in args or "--horizontal" in args:
    if "-H" in args:
        ...
        h_arg = args.index("--horizontal")

    try:
        top_bot = args[h_arg+1]
    except IndexError:
        top_bot = "-"
